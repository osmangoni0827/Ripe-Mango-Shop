...
import {faMapMarkedAlt,faEnvelope,faPhone, faLocationArrow, faMapMarkerAlt} from '@fortawesome/free-solid-svg-icons';
import { faFacebook, fgmail,faTwitter, faLinkedinIn, faYoutube} from '@fortawesome/free-brands-svg-icons'
