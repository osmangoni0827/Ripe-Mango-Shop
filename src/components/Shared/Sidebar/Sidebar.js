            ...
            <div className="sidebar">
                ...
                <ul className="navbar-nav ">
                    ...
                    <FontAwesomeIcon className='icon' icon={faPlusCircle} size='2x' color="#FFFFFF" />
                        ...
                        <NavLink activeClassName="active" className="nav-link " to='/addMango'>Add Mango Product</NavLink>
                    </li>

                    <li className="nav-item menu d-flex  align-items-center p-2 ">
                    <FontAwesomeIcon className='icon' icon={faPlusCircle} size='2x' color="#FFFFFF" />
                        <NavLink activeClassName="active" className="nav-link " to='/addChutney'>Add Chutney Recipe</NavLink>
                    </li>

                    <li className="nav-item menu d-flex  align-items-center  p-2">
                    <FontAwesomeIcon className='icon' icon={faPlusCircle} size='2x' color="#FFFFFF" />
                        <NavLink activeClassName="active" className="nav-link " to='/addPickle'>Add Mango Pickle</NavLink>
                    </li>
                    <li className="nav-item menu d-flex  align-items-center  p-2">
